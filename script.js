/**
 * =============================================
 * Aravind M - Portfolio JavaScript
...
const projectData = {
    billmint: {
        title: 'BillMint – SaaS Billing Platform',
        subtitle: 'Production-Ready SaaS Application',
        description: `
            <p>BillMint is a comprehensive, scalable SaaS-based billing and business management platform 
            designed to serve multiple business categories. Built from the ground up with PHP, MySQL, 
            HTML, CSS, and JavaScript, it provides a complete solution for businesses looking to 
            streamline their billing operations.</p>
            <h4>Key Features</h4>
            <ul>
                <li>Multi-business category support with customizable workflows</li>
                <li>Invoice generation with PDF export capabilities</li>
                <li>Customer management and relationship tracking</li>
                <li>Interactive dashboards with real-time business insights</li>
                <li>Secure authentication and authorization system</li>
                <li>Responsive UI design optimized for all devices</li>
                <li>SaaS-ready architecture for multi-tenant support</li>
                <li>Billing workflow automation and optimization</li>
            </ul>
            <h4>Impact</h4>
            <ul>
                <li>Transformed traditional billing into a scalable SaaS platform</li>
                <li>Reduced manual billing effort by automating key workflows</li>
                <li>Supports multiple businesses on a single platform</li>
                <li>Improved user accessibility with responsive design</li>
            </ul>
        `,
        tech: ['PHP', 'MySQL', 'HTML5', 'CSS3', 'JavaScript', 'SaaS Architecture', 'REST API', 'PDF Generation'],
...
// ============ CONSOLE GREETING ============
console.log(
    '%c👋 Hey there! Welcome to Aravind M\'s Portfolio',
